...
import kotlinx.android.synthetic.main.activity_e__maghrib.*
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.activity_main.back
import org.json.JSONArray
import org.json.JSONObject

class E_Maghrib : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_e__maghrib)
        ...
        btnSimpanMaghrib.setOnClickListener {

            var data_isiMaghrib = txtMaghrib.text.toString()

            postkeserver(data_isiMaghrib)
            ...
            .getAsJSONObject(object : JSONObjectRequestListener {
                override fun onResponse(response: JSONObject) { // do anything with response
                    ...
                    for (i in 0 until jsonArray.length()){
                        ...
                        txt44.setText(jsonObject.optString("maghrib"))
    ...
    fun postkeserver(data1:String){
        ...
        AndroidNetworking.post("http://192.168.0.7/jamsholat/proses-maghrib.php")
